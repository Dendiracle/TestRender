...
namespace rec 
{
    constexpr unsigned int shader_data_type_to_components_count(const ShaderDataType type)
    {
        ...
        logError("shader_data_type_to_component_type: unknown ShaderDataType!");
        return 0;
    }
    ...
    constexpr size_t shader_data_type_size(const ShaderDataType type)
    {
        ...
        logError("shader_data_type_size: unknown ShaderDataType!");
        return 0;
    }
    ...
    constexpr GLenum usage_to_GLenum(const VertexBuffer::EUsage usage)
    {
        ...
        logError("Unknown VertexBuffer usage");
    ...
    VertexBuffer::VertexBuffer(VertexBuffer&& vertexBuffer) noexcept : m_id(vertexBuffer.m_id)
